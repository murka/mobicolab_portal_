...
export class Init11591874355023 implements MigrationInterface {
    name = 'Init11591874355023'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "act" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "objectName" character varying NOT NULL, "place" character varying NOT NULL, "method" character varying NOT NULL, "toolType" character varying NOT NULL, "climaticEnvironmental" character varying NOT NULL, "planning" character varying NOT NULL, "normativeDocument" text array NOT NULL, "sampleType" character varying NOT NULL, "sample" text array NOT NULL, "preparation" text array NOT NULL, "goal" character varying NOT NULL, "definedIndicators" text array NOT NULL, "additions" character varying NOT NULL, "informationAboutSelection" character varying NOT NULL, "environmentalEngineer" character varying NOT NULL, "representative" character varying NOT NULL, "passedSample" character varying NOT NULL, "customerId" character varying, "generalCustomerId" character varying, "labId" character varying, "typeOfSampleHabitan" character varying NOT NULL, "typeOfSampleTypes" character varying NOT NULL, "datetimeDate" TIMESTAMP WITH TIME ZONE DEFAULT now(), "datetimeTime" character varying, "applicationPlace" character varying, "applicationDatetimeDate" TIMESTAMP WITH TIME ZONE DEFAULT now(), "applicationDatetimeTime" character varying, CONSTRAINT "PK_84c5378dc7f3b8355b6e8c3ccb0" PRIMARY KEY ("id"))`);
