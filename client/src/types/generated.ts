...
export type WholeActFragment = { __typename?: "Act" } & Pick<
  Act,
  | "id"
  | "name"
  | "objectName"
...
> & {
    ...
    generalCustomer: { __typename?: "GeneralCustomer" } & Pick<
      GeneralCustomer,
      "id"
    >;
    lab: { __typename?: "Lab" } & Pick<Lab, "id">;
    typeOfSample: { __typename?: "TypeOfSample" } & {
      habitan: { __typename?: "Habitan" } & Pick<Habitan, "id">;
      htype: { __typename?: "HType" } & Pick<HType, "id">;
    };
    datetime: { __typename?: "DateAndTime" } & Pick<
      DateAndTime,
      "date" | "time"
    >;
    applications: Array<
      { __typename?: "Application" } & Pick<Application, "id" | "place"> & {
          datetime: { __typename?: "DateAndTime" } & Pick<
            DateAndTime,
            "date" | "time"
          >;
...
export type WholeApplicationFragment = { __typename?: "Application" } & Pick<
  Application,
  "id" | "place"
> & {
    datetime: { __typename?: "DateAndTime" } & Pick<
...
export type PostActMutation = { __typename?: "Mutation" } & {
  createAct: { __typename?: "Act" } & Pick<Act, "id" | "name">;
};
...
export type PatchActMutation = { __typename?: "Mutation" } & {
  updateAct: { __typename?: "Act" } & Pick<Act, "id" | "name">;
};

export type CreatAppMutationVariables = Exact<{ [key: string]: never }>;

export type CreatAppMutation = { __typename?: "Mutation" } & {
...
export type CreateAppCopyMutation = { __typename?: "Mutation" } & {
  createAppCopy: { __typename?: "Application" } & WholeApplicationFragment;
};
...
export type DeleteAppMutation = { __typename?: "Mutation" } & {
  deleteApplication: { __typename?: "Application" } & Pick<Application, "id">;
};
...
export type DroppDocMutation = { __typename?: "Mutation" } & {
  droppDoc: { __typename?: "Doc" } & Pick<Doc, "id">;
};
...
export type RemoveDocMutation = { __typename?: "Mutation" } & {
  removeDoc?: Maybe<{ __typename?: "Doc" } & Pick<Doc, "id">>;
};
...
export type CreateLabTosRuleMutation = { __typename?: "Mutation" } & {
...
export type UpdateLabTosRuleMutation = { __typename?: "Mutation" } & {
...
export type CreatePdfMutation = { __typename?: "Mutation" } & {
  createPdf?: Maybe<{ __typename?: "PdfTemplater" } & Pick<PdfTemplater, "id">>;
};
...
export type CreateHabitanMutation = { __typename?: "Mutation" } & {
  createHabitan: { __typename?: "Habitan" } & Pick<Habitan, "id" | "label">;
};
...
export type CreateHTypeMutation = { __typename?: "Mutation" } & {
  createHabitansType: { __typename?: "HType" } & Pick<HType, "id" | "label">;
};
...
export type UpdateHabitanMutation = { __typename?: "Mutation" } & {
  updateHabitan: { __typename?: "Habitan" } & Pick<Habitan, "id" | "label"> & {
      htypes: Array<{ __typename?: "HType" } & Pick<HType, "id" | "label">>;
    };
};
...
export type UpdateHTypeMutation = { __typename?: "Mutation" } & {
  updateHabitansType: { __typename?: "HType" } & Pick<HType, "id" | "label">;
};
...
export type GetWholeCustomerQuery = { __typename?: "Query" } & {
  customer: { __typename?: "Customer" } & WholeCustomerFragment;
};

export type GetCustomersWithActsQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetCustomersWithActsQuery = { __typename?: "Query" } & {
  getCustomers: Array<
    { __typename?: "Customer" } & Pick<Customer, "id" | "label"> & {
        acts: Array<
          { __typename?: "Act" } & Pick<Act, "id" | "name"> & {
              datetime: { __typename?: "DateAndTime" } & Pick<
                DateAndTime,
                "date"
              >;
...
export type GetActIdsQuery = { __typename?: "Query" } & {
  getActs?: Maybe<Array<Maybe<{ __typename?: "Act" } & Pick<Act, "id">>>>;
};
...
export type GetWholeActQuery = { __typename?: "Query" } & {
  getAct: { __typename?: "Act" } & WholeActFragment;
};
...
export type GetGeneratePathQuery = { __typename?: "Query" } & {
  getLabTypeOfSampleTemplate?: Maybe<
    { __typename?: "LabTypeOfSampleTemplateModel" } & Pick<
...
export class PostActGQL extends Apollo.Mutation<
  PostActMutation,
  PostActMutationVariables
> {
...
export class PatchActGQL extends Apollo.Mutation<
  PatchActMutation,
  PatchActMutationVariables
> {
...
export class CreatAppGQL extends Apollo.Mutation<
  CreatAppMutation,
  CreatAppMutationVariables
> {
...
export class CreateAppCopyGQL extends Apollo.Mutation<
  CreateAppCopyMutation,
  CreateAppCopyMutationVariables
> {
...
export class DeleteAppGQL extends Apollo.Mutation<
  DeleteAppMutation,
...
export class DroppDocGQL extends Apollo.Mutation<
  DroppDocMutation,
  DroppDocMutationVariables
> {
...
export class CreateLabTosRuleGQL extends Apollo.Mutation<
  CreateLabTosRuleMutation,
  CreateLabTosRuleMutationVariables
> {
...
export class UpdateLabTosRuleGQL extends Apollo.Mutation<
  UpdateLabTosRuleMutation,
  UpdateLabTosRuleMutationVariables
> {
...
export class CreatePdfGQL extends Apollo.Mutation<
  CreatePdfMutation,
...
export class CreateHabitanGQL extends Apollo.Mutation<
  CreateHabitanMutation,
  CreateHabitanMutationVariables
> {
...
export class CreateHTypeGQL extends Apollo.Mutation<
  CreateHTypeMutation,
  CreateHTypeMutationVariables
> {
...
export class UpdateHabitanGQL extends Apollo.Mutation<
  UpdateHabitanMutation,
  UpdateHabitanMutationVariables
> {
...
export class UpdateHTypeGQL extends Apollo.Mutation<
  UpdateHTypeMutation,
  UpdateHTypeMutationVariables
> {
...
export class GetWholeCustomerGQL extends Apollo.Query<
  GetWholeCustomerQuery,
  GetWholeCustomerQueryVariables
> {
...
export class GetCustomersWithActsGQL extends Apollo.Query<
  GetCustomersWithActsQuery,
  GetCustomersWithActsQueryVariables
> {
...
export class GetWholeActGQL extends Apollo.Query<
  GetWholeActQuery,
  GetWholeActQueryVariables
> {
...
export class GetGeneratePathGQL extends Apollo.Query<
  GetGeneratePathQuery,
  GetGeneratePathQueryVariables
> {
